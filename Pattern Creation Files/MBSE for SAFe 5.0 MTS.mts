<MDG.Selections model="DBType=8;Connect=Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Projects\EA Projects\SAFe and MBSE model with content.eapx;Persist Security Info=False;LazyLoad=1;">
	<Technology id="SAFe5.0" name="MBSE for SAFe 5.0" version="0.0.25j" notes="This is an agile Model Based Systems Engineering (aMBSE) MDG that is intended for complex safety critical systems." filename="C:\Projects\Github version control\aMBSE\SAFe 5.0 MBSE Model Pattern\MBSE for SAFe 5.0 MDG.xml"/>
	<Profiles directory="C:\Projects\Github version control\aMBSE\Pattern Creation Files" files="MBSE for SAFe 5.0.xml"/>
	<TagVals tags="Actor Type,Arch Decisions,Attainable,Baseline Comparitive Action,BlockType,Capability Type,ConfidenceFactor,ContributionState,Customer Priority,EffectDirection,Email Address,End Date,End User Affected,Epic Type,ExecutionSprint,Feature Review Cycle,First Name,Gender,Hand Size,HypotethisState,InvestigationState,Key Stakeholders,Last Name,measurable,ObservationContribution,PartCategory,PartCost,PartCostQuantity,PartManufacturingProcess,PartToolingCost,PartType,Phone Number,PITag,Primary Organization Responsible,Priority,Question Label-1,Question Label-5,Question Prompt,Question Type,Rationale,Realistic,RefDesignSpec,RefHFStudy,RefHFStudyStation,RefModule,RefPart,RefPartSpec,RefUseCase,ReqToolID,Requirement Category,Scenario Type,SMART Analysis,Specific,SpecMet,SpecValue,SpecValueRule,Stakeholder Affected,Stakeholer Type,Start Date,Status,StoryPoints,subType,Test Type,Testable &amp; Traceable,TShirtSize,UseCaseLevel,UseCaseType,values,Verification Method,View Concerns,Visibility"/>
	<Images images=""/>
